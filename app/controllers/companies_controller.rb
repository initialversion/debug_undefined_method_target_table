class CompaniesController < ApplicationController
  def index
    ...
    @companies = @q.result(:distinct => true).includes(:clients, :designers, :projects, :items).page(params[:page]).per(10)
  ...
  def create
    ...
    @company.hours_available = params[:hours_available]
    @company.hours_used = params[:hours_used]
    @company.plan = params[:plan]
